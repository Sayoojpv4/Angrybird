...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Angrybird public bot' : process.env.ALL_CAPTION,
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '919207168374@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'Angry Bird' : process.env.BOT_NAME,
    SONGD: process.env.SONGD === undefined ? '𝘽𝙤𝙩 𝙨𝙚𝙖𝙧𝙘𝙝𝙞𝙣𝙜 𝙮𝙤𝙪𝙧 𝙨𝙤𝙣𝙜🔎🎶' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '𝘽𝙤𝙩 𝙪𝙥𝙡𝙤𝙖𝙙𝙞𝙣𝙜 𝙮𝙤𝙪𝙧 𝙨𝙤𝙣𝙜📲 𝙐𝙨𝙚🎧♥️' : process.env.SONGU,
    ...
    GIF_WEL: process.env.GIF_WEL === undefined ? 'https://i.imgur.com/DU0SgBq.mp4' : process.env.GIF_WEL,
    RASHI: process.env.LOGO_LINK === undefined ? 'https://i.imgur.com/Odjdrrh.jpeg' : process.env.LOGO_LINK,
    ...
    TAGPLK: process.env.TAG_HEADER === undefined ? 'Angry' : process.env.TAG_HEADER,
