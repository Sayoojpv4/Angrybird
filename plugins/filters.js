...
const array = ['Aada','Aah','Aarum illa','Adi','Adipowli','Advice','Aha','Aliya','Allarum evida','Anik','Ara','Athoke','Avastha','Ayi','Ayo','Aysheri','Bot','Bro','Bye','Chunk','Cr7','Da aliya','Da pina','Da','Dhrishya','Edaa','Enna','Enta mone','Entod','Fans','Fuck','Girls','Ha','Haa','Hi','Hii','Hlo','Hai','Hloo','Hm','I love u','Insult','Ishtaa','Ivana','Jada','K','Kanjaav','Killadi','Lionel','Makkale','Manas','Mass','Mention','Mm','Mng','Mrng','My','Nalla power','Ni','Niyum','Njamal','Njan vannu','Njan','No','Oh','Oho','Ok','Paal','Penn','Pennigal','Piller','Pina','Poda','Podey','Pora','Power evide','Ringtone','Sarulla','Set aak','Set','Silent','Single','Song','Subscribe','Thanks','Thug','Umbi','Vaada','Vada','Wow','Yes','Yo','adich','alive','aliya','an','ayilla','bg','bot','broke','chaya','chunk','come on','da','dey','don','entry','git','help','ho','hot','k','kayari','king','kiss','kozhi','kundan','left','list','love','mention','messi','mood','mp3','muth','muthe','myr','myre','nanba','nari','nee','neymar','night','gd n8','nyt','number save','number','oho','oi','oii','ok','oo','omban','on','one','onn','owner','player','poda','power','rashii','sad','ser','set','setta','she','sir','some','song','stop','text','trance','umbi','uyir','va','vanne','vannu','varum','wow','ko','ma','od','sha','ya','an','apo','bomb','ee','k','list','machu','menu','mute','onn','oo','pa','so','unmute','wait','adi','army','bye','chaya','edit','ip','kayari','la','mari','money','monu','nallath','night','nyt','rashii','on','patti','po','poth','sir','Hy','Di','Bye','Ara','Adi','Aarulle','Anthas','Good bye','Hehe','ah','be','Qr','sa','lo','se','ch','by','ban','name entha','King','Tuttu','Azaru','Ramos','Tentacion','baby','Love','nirthada','Neymar','umma','Kurup','Friend','Rose','aara','Alone','ayilla','bie','Chiri','colony','enth','entha','Fuck','Goal','Hambada','Kanja','Killedi','kuthirappavan','Meeting','mier','moonji','Oh no','pever','Potta','Serious','Soldier','Sry','Subscribe','thottu','Va','Vada','vimanam','sorry','nanban','Lala','Smile','ghost','La be','Sed','Uff','Legend','music','Fek','Psycho','Town','Pwoli','Uyir','Malang','Bad','Thamasha','big fan','charlie','gd n8','kar98','love u','Endi','endi','noob','Poweresh','Perfect ok','perfect ok','power','saji','sed','single','waiting','Myr','myr','Malappuram','uyir','thug','avastha','Moodesh','sketched','Cr7','Z aayi','manasilayo','Poda','nirtheda','Cr7 back','Portugal','ennitt','Boss','Haters','ayn','Kgf','sed bgm','Messi','hehe','Set aano','set aano','Bot myren','Venda','venda','chadhi','Chadhi','Hbday','hbday','R yyi padicho','Myre','myre','Oompi','oompi','parayatte','Fresh','fresh','Ok da','ok da','Feel aayi','feel aaayi','Scene','scene','Ok bei','ok bei','Kozhi','kozhi','adi','kali','Kali','thantha','Thantha','aysheri','thund','Thund','thot','Thot','sneham','Sneham','pm','Pm','paatt','Paatt','njan','life','Life','Killadi','killadi','good bye','evide','Evide','achan','Achan','kunna','Kunna','broken','Broken','why','Why','enth patti','Enth patti','pani','Pani','padicho','Padicho','paad','Paad','Chatho','bahubali','birthday','dora','nirthada','sugham','onn podo','chatho','lover','Lover','nanayikoode','Nanayikoode','Die','die','hate','Hate','nallath','Nallath','Neymer','neymer','patti','Patti','poora','Poora','thall','Thall','Theri','theri','potte','Potte','Caption','caption','onn poyi','Onn poyi','problem','Problem','Master','Enthupatti','Kariyam','Sed','Sad','Mm','Pennu','Para','Oh','Pilleru','Theapp','Kakka','Kollam','mathi','Music','music','Sana','Frd','Ponu','ponu','vannu','Mrng','mm','Vedi','vedi','don','Pic','pic','Dj','Oo','T','hi','Thampuran','Gd night','songs','No','Ooi','Podi','podi','nee','Don','M','poyi','bgm','BGM','Bgm','Nanban','anthas','ayitt','Ayn','But y','Ennitt','Entry','Evide','Haha','Happy','Ithentha','Ivanetha','Left','Link','mp3','oi','Safeer','sticker','trance','tts','varunnilla','video','welcome','Aswathy','Sayooj','Sayumon','Aa','Aah','Allah','Group','How','Mng','Muthe','Nanba','Ni','Odiko','Njn','Photo','converting','avan','caption','img','link','Admin','Dream','Ee','Fan','free','grp','Hbd','Kooi','Malayalam','Men','Recharge','voice','tagall']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
const array = ['Zara','Bye','bye','Poli','Dance','Gd mrng','Ara','Poyi','poda','podi','Pain','girl','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','love','list','machu','menu','mute','nee','onn','oo','pa','so','unmute','wait','adi','army','bye','chaya','edit','ip','kayari','la','mari','money','monu','nallath','night','nyt','on','patti','po','poth','sir','a','Hii','ee','Da','food','Hlo','para','love u','set','sed','jada','Hi','sad','don','Loki','Aada','Ara','Bgm','Dance','Dey','Di','Error','Fuck','Group','Muthe','Poli','Remove','Sayooj','Sayumon','Tripp','alive','ayin','bot','come','copy','done','escape','get','help','hm','img','kali','song','let','lost','myr','ni','nice','nokk','not','oh','oru','photo','podey','podi','pottan','run','ser','sex','sorry','truth','mention','welcome','Sayumon','sticker']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
