...
const array = ['Zara','Bye','bye','Dance','Gd mrng','Poyi','poda','podi','Pain','girl','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','list','machu','menu','mute','nee','onn','oo','pa','so','unmute','wait','adi','army','bye','chaya','edit','ip','kayari','la','mari','money','monu','nallath','night','nyt','on','patti','po','poth','sir','a','Hii','ee','Da','food','Hlo','para','love u','set','sed','jada','Hi','sad','don','Loki','Aada','Ara','Bgm','Dance','Dey','Di','Error','Fuck','Group','Muthe','Poli','Remove','Sayooj','Sayumon','Tripp','alive','ayin','bot','come','copy','done','escape','get','help','hm','img','kali','song','let','lost','myr','ni','nice','nokk','not','oh','oru','photo','podey','podi','pottan','run','ser','sex','sorry','truth','mention','welcome','sticker']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
